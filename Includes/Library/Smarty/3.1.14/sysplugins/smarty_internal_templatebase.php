...
abstract class Smarty_Internal_TemplateBase extends Smarty_Internal_Data
{
    ...
    public function fetch(
        ...
        if (!($_template->caching == Smarty::CACHING_LIFETIME_CURRENT || $_template->caching == Smarty::CACHING_LIFETIME_SAVED)
            ...
            if ($_template->parent instanceof Smarty_Internal_Template) {
                $_template->parent->properties['file_dependency'] = array_merge(
                    $_template->parent->properties['file_dependency'],
            ...
            if (!$_template->source->recompiled
                ...
                if (!empty($_template->properties['nocache_hash']) && !empty($_template->parent->properties['nocache_hash'])) {
                    ...
                    $_output                             = str_replace(
                        ...
                        $_template->parent->properties['nocache_hash'],
                        $_output
                    );
        ...
        if ((!$this->caching || $_template->has_nocache_code || $_template->source->recompiled) && !$no_output_filter
                        ...
                        case 'cli':
                            ...
                            !empty($_SERVER['SMARTY_PHPUNIT_DISABLE_HEADERS']) /* phpunit$ */
                                ...
                                $_SERVER['SMARTY_PHPUNIT_HEADERS'][]
                                    = 'Last-Modified: ' . gmdate('D, d M Y H:i:s', $_template->cached->timestamp) . ' GMT';
                            }
                            break;
