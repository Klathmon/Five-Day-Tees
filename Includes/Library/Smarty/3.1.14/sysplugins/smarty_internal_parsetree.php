...
class _smarty_doublequoted extends _smarty_parsetree
{
    ...
    public function append_subtree(_smarty_parsetree $subtree)
    {
        ...
        if ($last_subtree >= 0 && $this->subtrees[$last_subtree] instanceof _smarty_tag
            && $this->subtrees[$last_subtree]->saved_block_nesting < $this->parser->block_nesting_level
        ) {
...
class _smarty_template_buffer extends _smarty_parsetree
{
    ...
    public function to_smarty_php()
    {
        ...
        for ($key = 0, $cnt = count($this->subtrees); $key < $cnt; $key++) {
            if ($key + 2 < $cnt) {
                if ($this->subtrees[$key] instanceof _smarty_linebreak && $this->subtrees[$key + 1] instanceof _smarty_tag
